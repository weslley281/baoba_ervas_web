...
<head>
    ...
    <title>Painel do Atendente - Centro</title>
...
<body>
        ...
        <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="card card-custom p-5 w-100 bg-white" style="max-width: 420px;">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted small">Cuiabá Centro</p>
                </div>
    ...
    <?php else: ?>
        ...
        <nav class="navbar navbar-dark navbar-green shadow-sm mb-5">
            <div class="container">
                <a class="navbar-brand fw-bold" href="#"><i class="fa-solid fa-leaf"></i> Baobá Ervas - Centro</a>
